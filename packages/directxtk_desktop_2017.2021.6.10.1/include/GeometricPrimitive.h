...
namespace DirectX
{
    ...
    public:
        ...
        static std::unique_ptr<GeometricPrimitive> __cdecl CreateSphere(_In_ ID3D11DeviceContext* deviceContext, float diameter = 0.1, size_t tessellation = 16, bool rhcoords = true, bool invertn = false);
